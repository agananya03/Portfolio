    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='grid grid-cols-auto my-10 gap-5 dark:text-black'>
        {workData.map((project, index) => (
          ...
          key={index} style={{backgroundImage: `url(${project.bgImage})`}} className='aspect-square cursor-pointer bg-no-repeat bg-cover bg-center rounded-lg relative group'>
      ...
      href="" className='flex items-center justify-center w-max gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500 dark:text-white dark:border-white dark:hover:bg-darkHover'>Show More
